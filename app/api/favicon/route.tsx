...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://wuji.io/favicons/zolplay.png',
  '(?:github.com)': 'https://wuji.io/favicons/github.png',
  '((?:t.co)|(?:twitter.com))': 'https://wuji.io/favicons/twitter.png',
  'coolshell.cn': 'https://wuji.io/favicons/coolshell.png',
  'vercel.com': 'https://wuji.io/favicons/vercel.png',
  'nextjs.org': 'https://wuji.io/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://wuji.io/favicon_blank.png'
